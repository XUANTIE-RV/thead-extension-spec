[#xtheadmemidx-insns-sbib,reftext=Store indexed byte, increment-before]
==== th.sbib
...
Mnemonic::
th.sbib _rd_, (_rs1_), _imm5_, _imm2_
...
After the increment of _rs1_, this instruction stores an 8-bit value from the GP register _rd_ to the (incremented) address _rs1_.
