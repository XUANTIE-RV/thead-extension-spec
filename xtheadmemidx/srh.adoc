[#xtheadmemidx-insns-srh,reftext=Store indexed half-word]
==== th.srh
...
Description::
This instruction stores a 16-bit value from the GP register _rd_ to the address _rs1_ + (_rs2_ << _imm2_).
